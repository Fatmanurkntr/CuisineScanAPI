# data.py (SADELEŞTİRİLMİŞ FİNAL VERSİYONU)
# Sadece dil-bağımsız teknik verileri ve sınıf listelerini içerir.
...
# Anahtar olarak İngilizce ve standart isimleri kullanıyoruz.
# Bu sözlük artık sadece dil-bağımsız, sayısal veri içeriyor.
FOOD_DATA = {
    ...
    'gözleme': {'nutrition_info': {'calories_per_100g': 260, 'default_serving_size_g': 250}}, # 'gozleme' olarak düzeltildi
